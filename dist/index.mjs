...
import { useState as useState4, useCallback as useCallback4, useRef as useRef2, useEffect as useEffect2, memo as memo9 } from "react";
...
var ChatHeader = memo(function ChatHeader2({
  ...
  return /* @__PURE__ */ jsxs("header", { className: "flex items-center justify-between px-6 py-4 min-h-[60px] border-b border-border bg-black/5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-base font-semibold text-foreground", children: [
      /* @__PURE__ */ jsx(Bot, { size: 20 }),
      /* @__PURE__ */ jsx("span", { children: title }),
      isStreaming && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-500/15 text-primary border border-blue-500/25", children: [
...
import { Search, Zap, Sparkles, ChevronUp, X as X2 } from "lucide-react";
...
var DeepResearchToggle = memo2(function DeepResearchToggle2({
  className,
  compact = true
}) {
    ...
    return /* @__PURE__ */ jsxs2("div", { className: cn("relative", className), children: [
      /* @__PURE__ */ jsxs2(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx2(Icon, { size: 14, className: enabled ? config.color : "" }),
            enabled && /* @__PURE__ */ jsxs2(Fragment, { children: [
              /* @__PURE__ */ jsx2("span", { className: "hidden sm:inline", children: config.label }),
              /* @__PURE__ */ jsx2(
                ChevronUp,
                {
                  size: 12,
            ...
            !enabled && /* @__PURE__ */ jsx2("span", { className: "hidden sm:inline", children: "Research" })
          ]
        }
      ),
      enabled && /* @__PURE__ */ jsx2(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsx2(X2, { size: 10 })
        }
      ),
      /* @__PURE__ */ jsx2(AnimatePresence, { children: showOptions && enabled && /* @__PURE__ */ jsx2(
        motion.div,
        {
            ...
            (level) => {
              ...
              return /* @__PURE__ */ jsxs2(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx2(LevelIcon, { size: 14, className: levelConfig.color }),
                    /* @__PURE__ */ jsx2("span", { className: "flex-1 text-left font-medium", children: levelConfig.label }),
                    /* @__PURE__ */ jsx2("span", { className: "text-[10px] opacity-60", children: levelConfig.time })
                  ]
                },
                level
              );
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-1.5 flex-1", children: [
          /* @__PURE__ */ jsx2(
            Search,
            {
              size: 14,
        ...
        enabled && /* @__PURE__ */ jsx2("div", { className: "flex gap-1", children: Object.keys(EFFORT_CONFIG).map(
          (level) => {
            const levelConfig = EFFORT_CONFIG[level];
            const LevelIcon = levelConfig.icon;
            const isSelected = level === effortLevel;
            return /* @__PURE__ */ jsx2(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx2(LevelIcon, { size: 14 })
              },
              level
            );
          }
...
var ChatInput = memo3(function ChatInput2({
  ...
  return /* @__PURE__ */ jsx3("div", { className: "border-t border-border bg-black/15", children: /* @__PURE__ */ jsxs3("div", { className: "flex items-end gap-2 p-4", children: [
    /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-1 shrink-0 self-end mb-1.5", children: [
      onAttach && /* @__PURE__ */ jsx3(
        "button",
        {
          type: "button",
          onClick: onAttach,
          ...
          children: /* @__PURE__ */ jsx3(Paperclip, { size: 18 })
        }
      ),
      showDeepResearch && /* @__PURE__ */ jsx3(DeepResearchToggle, { compact: true })
    ] }),
    /* @__PURE__ */ jsx3(
      "textarea",
      {
    ...
    /* @__PURE__ */ jsx3(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx3(SendHorizontal, { size: 20 })
      }
    )
  ] }) });
});
...
var SuggestionChips = memo5(function SuggestionChips2({
  ...
  return /* @__PURE__ */ jsx5("div", { style: suggestionChipStyles.container, children: suggestions.map((suggestion, index) => /* @__PURE__ */ jsx5(
    "button",
    {
      type: "button",
      ...
      return /* @__PURE__ */ jsxs4("div", { className: "flex flex-col gap-2 w-full", children: [
        /* @__PURE__ */ jsxs4(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsx7("option", { value: "", children: field.placeholder || "Select an option..." }),
              field.options?.map((opt) => /* @__PURE__ */ jsx7("option", { value: opt.value, children: opt.label }, opt.value)),
              field.allowCustom && /* @__PURE__ */ jsx7("option", { value: "__custom__", children: "Other..." })
            ]
          }
        ),
        isCustomSelected && /* @__PURE__ */ jsx7(
          "input",
          {
            type: "text",
            value: customValue || "",
...
function QuickReplyForm({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: CONTAINER_CLASS, children: [
    ...
    /* @__PURE__ */ jsxs5("div", { className: "flex flex-wrap gap-2", children: [
      ...
      question.allowCustom && /* @__PURE__ */ jsx8(
        "button",
        {
          type: "button",
...
function QuestionForm({
  ...
  const [showCustomInput, setShowCustomInput] = useState3({});
  const [customValues, setCustomValues] = useState3({});
  ...
  const handleFieldChange = useCallback3((fieldId, value) => {
    setValues((prev) => ({ ...prev, [fieldId]: value }));
    if (value !== "__custom__") {
      setShowCustomInput((prev) => ({ ...prev, [fieldId]: false }));
    }
  }, []);
  const handleCustomToggle = useCallback3((fieldId, show) => {
    setShowCustomInput((prev) => ({ ...prev, [fieldId]: show }));
    if (show) {
      setValues((prev) => ({ ...prev, [fieldId]: "__custom__" }));
    }
  }, []);
  const handleCustomValueChange = useCallback3(
    (fieldId, value) => {
  ...
  const handleQuickReply = useCallback3(
    (optionValue) => {
  ...
  if (question.type === "text") {
    return /* @__PURE__ */ jsx9("div", { className: CONTAINER_CLASS, children: /* @__PURE__ */ jsx9("div", { className: QUESTION_TEXT_CLASS, children: question.text }) });
  }
  ...
  return /* @__PURE__ */ jsxs6("div", { className: CONTAINER_CLASS, children: [
    ...
    /* @__PURE__ */ jsxs6("form", { onSubmit: handleSubmit, className: "flex flex-col gap-3", children: [
      ...
      ] }, field.id)) : /* @__PURE__ */ jsx9("div", { className: "flex flex-col gap-1 w-full", children: /* @__PURE__ */ jsx9(
        "input",
        {
          type: "text",
...
var MarkdownMessage = memo7(function MarkdownMessage2({
  content,
  style
}) {
  const renderText = useRenderText();
  return /* @__PURE__ */ jsx10("div", { style, children: renderText(content) });
});
...
var ToolProgressIndicator = memo8(function ToolProgressIndicator2({
  toolProgress,
  className
}) {
  ...
  return /* @__PURE__ */ jsx11("div", { className: cn("flex flex-col gap-2 px-4 py-3", className), children: activeTools.map((progress) => /* @__PURE__ */ jsx11(ToolProgressItem, { progress }, progress.toolCallId)) });
});
var ToolProgressItem = memo8(function ToolProgressItem2({
  progress
}) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs7("div", { className: "relative", children: [
          /* @__PURE__ */ jsx11(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx11(ToolIcon, { toolName: progress.toolName })
            }
          ),
        ...
        /* @__PURE__ */ jsxs7("div", { className: "flex-1 min-w-0", children: [
          ...
          progress.message && /* @__PURE__ */ jsx11("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: progress.message }),
          isDeepResearch && isProgress && progressPercent > 0 && /* @__PURE__ */ jsx11("div", { className: "mt-2 h-1.5 w-full bg-white/10 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx11(
            "div",
            {
      ...
      return /* @__PURE__ */ jsxs7(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx11("line", { x1: "16", y1: "13", x2: "8", y2: "13" }),
            /* @__PURE__ */ jsx11("line", { x1: "16", y1: "17", x2: "8", y2: "17" })
          ]
        }
      );
    case "search-flight":
      return /* @__PURE__ */ jsx11(
        "svg",
        {
          ...
          strokeLinecap: "round",
          strokeLinejoin: "round",
          children: /* @__PURE__ */ jsx11("path", { d: "M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z" })
        }
      );
    case "search-hotel":
      return /* @__PURE__ */ jsxs7(
        "svg",
        {
          ...
          strokeLinejoin: "round",
          children: [
            /* @__PURE__ */ jsx11("path", { d: "M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z" }),
            /* @__PURE__ */ jsx11("path", { d: "M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2" }),
            /* @__PURE__ */ jsx11("path", { d: "M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2" }),
            /* @__PURE__ */ jsx11("path", { d: "M10 6h4" }),
            /* @__PURE__ */ jsx11("path", { d: "M10 10h4" }),
            /* @__PURE__ */ jsx11("path", { d: "M10 14h4" }),
            /* @__PURE__ */ jsx11("path", { d: "M10 18h4" })
          ]
        }
      );
    case "deep-research":
      return /* @__PURE__ */ jsxs7(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx11("path", { d: "M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9-4.54-4.52-9.87-6.54-11.9-4.5-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5Z" }),
            /* @__PURE__ */ jsx11("path", { d: "M15.7 15.7c4.52-4.54 6.54-9.87 4.5-11.9-2.03-2.04-7.36-.02-11.9 4.5-4.52 4.54-6.54 9.87-4.5 11.9 2.03 2.04 7.36.02 11.9-4.5Z" })
          ]
        }
      );
    default:
      return /* @__PURE__ */ jsx11(
        "svg",
        {
          ...
          strokeLinecap: "round",
          strokeLinejoin: "round",
          children: /* @__PURE__ */ jsx11("polygon", { points: "13,2 3,14 12,14 11,22 21,10 12,10 13,2" })
        }
      );
  }
});
...
var ChatPanel = memo9(function ChatPanel2({
  ...
  const handleSelectionSubmit = useCallback4(() => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx12("div", { className: "flex flex-col gap-6 p-6 flex-1 overflow-y-auto", children: !hasMessages ? /* @__PURE__ */ jsx12(EmptyState, {}) : /* @__PURE__ */ jsxs8(Fragment3, { children: [
            ...
            turn.assistantMessages?.map(
              (msg, idx) => /* @__PURE__ */ jsx12(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx12(MarkdownMessage, { content: msg.content })
                },
                `${turn.id}-msg-${idx}`
              )
            ),
            turn.toolProgress && turn.toolProgress.length > 0 && /* @__PURE__ */ jsx12(ToolProgressIndicator, { toolProgress: turn.toolProgress }),
            turn.questions?.map(
              (question, qIdx) => {
          ...
          isStreaming && /* @__PURE__ */ jsx12(TypingIndicator, {}),
          /* @__PURE__ */ jsx12("div", { ref: messagesEndRef })
        ] }) }),
        suggestions.length > 0 && !isStreaming && /* @__PURE__ */ jsx12(
          SuggestionChips,
          {
            suggestions,
        ...
        isInSelectionMode ? /* @__PURE__ */ jsxs8("div", { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsxs8("div", { className: "flex gap-2 mt-2", children: [
            ...
            onSelectionDelete && /* @__PURE__ */ jsx12(
              "button",
              {
                type: "button",
...
function ConversationInteractiveElements({
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { ...CONTAINER_STYLE, ...style }, className, children: [
    ...
    !isStreaming && suggestions.length > 0 && /* @__PURE__ */ jsx13(
      SuggestionChips,
      {
        suggestions,
...
var icons = {
  plan: /* @__PURE__ */ jsxs10(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      children: [
        /* @__PURE__ */ jsx14("path", { d: "M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" }),
...
var StepItem = ({
  ...
  "div",
  {
    ...
    children: [
      /* @__PURE__ */ jsx15("div", { style: styles.stepNumber, children: isSubtask ? "\u2022" : index + 1 }),
      /* @__PURE__ */ jsx15(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxs11(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx15("span", { children: step.agent })
          ]
        }
      )
    ]
...
var PlanningStatus = memo10(
  function PlanningStatus2({
    ...
    return /* @__PURE__ */ jsxs12("div", { style: styles.container, children: [
      ...
      /* @__PURE__ */ jsx16("div", { style: styles.progressBar, children: /* @__PURE__ */ jsx16("div", { style: { ...styles.progressFill, width: `${progress}%` } }) }),
      /* @__PURE__ */ jsx16("div", { style: styles.steps, children: plan.steps.map((step, index) => {
        ...
        return /* @__PURE__ */ jsxs12("div", { children: [
          ...
          step.subtasks && step.subtasks.length > 0 && /* @__PURE__ */ jsx16("div", { style: styles.subtasksContainer, children: step.subtasks.map((subtask, subIndex) => /* @__PURE__ */ jsx16(
            StepItem,
            {
              step: subtask,
              index: subIndex,
...
var ICONS = {
  plan: /* @__PURE__ */ jsx17(
    "svg",
    {
      ...
      stroke: "currentColor",
      strokeWidth: "2",
      children: /* @__PURE__ */ jsx17("path", { d: "M22 12h-4l-3 9L9 3l-3 9H2" })
    }
  ),
  spinner: /* @__PURE__ */ jsx17(
    "svg",
    {
      width: "14",
      height: "14",
      ...
      strokeWidth: "2",
      className: "spinner",
      children: /* @__PURE__ */ jsx17("path", { d: "M21 12a9 9 0 1 1-6.219-8.56" })
    }
  ),
  check: /* @__PURE__ */ jsx17(
    "svg",
    {
      width: "14",
      height: "14",
  ...
  search: /* @__PURE__ */ jsxs13(
    "svg",
    {
      ...
      strokeWidth: "2",
      children: [
        /* @__PURE__ */ jsx17("circle", { cx: "11", cy: "11", r: "8" }),
        /* @__PURE__ */ jsx17("path", { d: "m21 21-4.3-4.3" })
      ]
    }
  ),
  document: /* @__PURE__ */ jsxs13(
    "svg",
    {
      ...
      strokeWidth: "2",
      children: [
        /* @__PURE__ */ jsx17("path", { d: "M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" }),
        /* @__PURE__ */ jsx17("polyline", { points: "14,2 14,8 20,8" })
      ]
    }
  ),
  plane: /* @__PURE__ */ jsx17(
    "svg",
    {
      width: "14",
      height: "14",
  ...
  building: /* @__PURE__ */ jsxs13(
    "svg",
    {
      ...
      strokeWidth: "2",
      children: [
        /* @__PURE__ */ jsx17("path", { d: "M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z" }),
        /* @__PURE__ */ jsx17("path", { d: "M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2" }),
        /* @__PURE__ */ jsx17("path", { d: "M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2" })
      ]
    }
  ),
  zap: /* @__PURE__ */ jsx17(
    "svg",
    {
      ...
      stroke: "currentColor",
      strokeWidth: "2",
      children: /* @__PURE__ */ jsx17("polygon", { points: "13,2 3,14 12,14 11,22 21,10 12,10 13,2" })
    }
  )
};
...
var UnifiedProgressIndicator = memo11(
  function UnifiedProgressIndicator2({ className }) {
    ...
    return /* @__PURE__ */ jsxs14("div", { className: cn("unified-progress", className), children: [
      /* @__PURE__ */ jsx18("style", { children: KEYFRAMES }),
      isOrchestrating && plan && metrics && /* @__PURE__ */ jsx18(
        PlanSection,
        {
          plan,
          metrics,
      ...
      activeTools.length > 0 && /* @__PURE__ */ jsx18(ToolSection, { tools: activeTools, hasPlan: Boolean(plan) })
    ] });
  }
);
var PlanSection = memo11(function PlanSection2({
  plan,
  metrics,
  parallelLevel
}) {
  return /* @__PURE__ */ jsxs14("div", { className: "plan-section", children: [
    /* @__PURE__ */ jsxs14("div", { className: "plan-header", children: [
      /* @__PURE__ */ jsxs14("div", { className: "plan-header-left", children: [
        /* @__PURE__ */ jsx18("div", { className: "plan-icon", children: ICONS.plan }),
        /* @__PURE__ */ jsxs14("div", { className: "plan-header-content", children: [
          ...
          /* @__PURE__ */ jsx18("span", { className: "plan-goal", children: plan.goal })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsx18(StepsList, { steps: plan.steps })
  ] });
});
var StepsList = memo11(function StepsList2({ steps }) {
  return /* @__PURE__ */ jsx18("div", { className: "steps-list", children: steps.map((step, index) => /* @__PURE__ */ jsx18(StepItem2, { step, index }, step.id)) });
});
var StepItem2 = memo11(function StepItem3({ step, index }) {
        ...
        /* @__PURE__ */ jsxs14(
          "div",
          {
            ...
            children: [
              ...
              isPending && /* @__PURE__ */ jsx18("span", { className: "step-number", children: index + 1 })
            ]
          }
        ),
        /* @__PURE__ */ jsx18("div", { className: "step-content", children: /* @__PURE__ */ jsx18("span", { className: "step-task", children: step.task }) }),
        /* @__PURE__ */ jsx18("span", { className: cn("agent-badge", isActive && "badge-active"), children: step.agent })
      ]
    }
  );
});
var ToolSection = memo11(function ToolSection2({
  tools,
  hasPlan
}) {
  return /* @__PURE__ */ jsx18("div", { className: cn("tool-section", hasPlan && "tool-section-nested"), children: tools.map((tool) => /* @__PURE__ */ jsx18(ToolItem, { tool }, tool.toolCallId)) });
});
var ToolItem = memo11(function ToolItem2({ tool }) {
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "tool-item", children: [
    /* @__PURE__ */ jsx18("div", { className: "tool-icon", children: getToolIcon(tool.toolName) }),
    /* @__PURE__ */ jsxs14("div", { className: "tool-content", children: [
      /* @__PURE__ */ jsx18("span", { className: "tool-name", children: formatToolName(tool.toolName) }),
      tool.message && /* @__PURE__ */ jsx18("span", { className: "tool-message", children: tool.message })
    ] }),
    isActive && /* @__PURE__ */ jsx18("span", { className: "tool-indicator", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsx18(
      "span",
      {
        className: "dot",
...
import { SendHorizontal as SendHorizontal2, Paperclip as Paperclip2, Plus } from "lucide-react";
...
var getIconForType = (type) => {
  switch (type) {
    case "document":
      return /* @__PURE__ */ jsx19(FileText, { size: 14 });
    case "spreadsheet":
      return /* @__PURE__ */ jsx19(FileSpreadsheet, { size: 14 });
    case "presentation":
      return /* @__PURE__ */ jsx19(Presentation, { size: 14 });
    case "image":
      return /* @__PURE__ */ jsx19(ImageIcon, { size: 14 });
    case "library-document":
      return /* @__PURE__ */ jsx19(Library, { size: 14, className: "text-blue-400" });
    default:
      return /* @__PURE__ */ jsx19(FileIcon, { size: 14 });
  }
};
  ...
  return /* @__PURE__ */ jsxs15(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx19("span", { className: "truncate flex-1", children: fileName }),
        /* @__PURE__ */ jsx19(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsx19(X3, { size: 10 })
          }
        )
      ]
    }
...
function ActionMenu({
  ...
  return /* @__PURE__ */ jsx20(AnimatePresence2, { children: isOpen && /* @__PURE__ */ jsx20(
    motion2.div,
    {
      ref: menuRef,
      ...
      children: /* @__PURE__ */ jsxs16("div", { className: "p-1.5 flex flex-col gap-1", children: [
        onOpenSettings && /* @__PURE__ */ jsxs16(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx20(Settings2, { size: 16 }),
              "Settings"
            ]
          }
        ),
        onToggleDocumentEditor && /* @__PURE__ */ jsxs16(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx20(FileEdit, { size: 16 }),
        ...
        onToggleCopilotMode && /* @__PURE__ */ jsxs16(
          "button",
          {
            ...
            children: [
              messagesMode === "copilot" ? /* @__PURE__ */ jsx20(PanelRightClose, { size: 16 }) : /* @__PURE__ */ jsx20(PanelRightOpen, { size: 16 }),
        ...
        onToggleHideMessages && /* @__PURE__ */ jsxs16(
          "button",
          {
            ...
            children: [
              messagesMode === "hidden" ? /* @__PURE__ */ jsx20(EyeOff, { size: 16 }) : /* @__PURE__ */ jsx20(Eye, { size: 16 }),
              messagesMode === "hidden" ? "Show Messages" : "Hide Messages"
            ]
          }
        ),
        canClear && onClear && /* @__PURE__ */ jsxs16(Fragment4, { children: [
          /* @__PURE__ */ jsx20("div", { className: "h-px bg-white/5 my-1" }),
          /* @__PURE__ */ jsxs16(
            "button",
            {
              onClick: () => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs17(
          "div",
          {
            ...
            children: [
              isDragActive && /* @__PURE__ */ jsx21("div", { className: "absolute inset-0 rounded-[18px] sm:rounded-[20px] border border-primary/60 pointer-events-none flex items-center justify-center", children: /* @__PURE__ */ jsx21("span", { className: "text-xs uppercase tracking-widest text-primary font-semibold", children: "Drop files to attach" }) }),
              attachments.length > 0 && /* @__PURE__ */ jsx21("div", { className: "flex gap-2 p-1 pb-2 w-full overflow-x-auto", children: attachments.map((attachment) => /* @__PURE__ */ jsx21(
                FileAttachmentBadge,
                {
                  attachment,
              ...
              /* @__PURE__ */ jsxs17("div", { className: "flex items-center gap-2 sm:gap-3 w-full", children: [
                /* @__PURE__ */ jsxs17("div", { className: "flex items-center gap-0.5 sm:gap-1 shrink-0", children: [
                  ...
                  /* @__PURE__ */ jsx21(
                    "button",
                    {
                      ...
                      title: "Actions",
                      children: /* @__PURE__ */ jsx21(Plus, { size: 18, className: "sm:w-5 sm:h-5" })
                    }
                  ),
                  /* @__PURE__ */ jsx21(
                    "button",
                    {
                      ...
                      title: "Attach files",
                      children: /* @__PURE__ */ jsx21(Paperclip2, { size: 18, className: "sm:w-5 sm:h-5" })
                    }
                  ),
                  showDeepResearch && /* @__PURE__ */ jsx21(DeepResearchToggle, { compact: true })
                ] }),
                /* @__PURE__ */ jsx21(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsx21(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsx21(SendHorizontal2, { size: 16, className: "sm:w-[18px] sm:h-[18px]" })
                  }
                )
              ] })
            ]
...
function useChatAttachments() {
  ...
  const addFiles = useCallback6((files) => {
  ...
  const addLibraryDocument = useCallback6(
    (doc) => {
      const attachment = {
  ...
  const triggerFileSelect = useCallback6(() => {
...
var formFieldOptionSchema = z.object({
  value: z.string(),
  label: z.string()
});
...
var quickReplyOptionSchema = z.object({
  id: z.string(),
  label: z.string(),
...
var questionPayloadSchema = z.object({
  id: z.string(),
  text: z.string(),
...
var conversationTurnSchema = z.object({
  id: z.string(),
